...
const getMockTracking = (orderId: string) => ({
  ...
  items: [
    { title: "Fresh Bananas 1kg", qty: 1, price: "₹99", image: "/images/veg/Bananas_product_.jpeg" },
    { title: "India Gate Rice 1kg", qty: 1, price: "₹249", image: "/images/grocery/India_Gate_Rice.jpeg" }
  ],
  totals: {
    subtotal: "₹348",
    delivery: "Free",
