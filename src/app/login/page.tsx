      ...
      <div className="z-10 w-full max-w-[440px] flex flex-col items-center">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-500 text-[14px]">
            Sign in to continue shopping with Woxly
          </p>
          <p className="text-gray-500 text-[13px] mt-4">
            New here? <Link href="/signup" className="text-primary font-semibold hover:underline transition-all">Create an account →</Link>
          </p>
        </div>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="text-[12px] text-[primary hover:underline font-medium transition-all">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
